...
###
# Stolen from: https://github.com/asozialesnetzwerk/an-website/blob/fd260e4585595f9836bbbb5d9ff2c16e549e636a/generate-badge.sh
# This script is used in the GitHub Actions workflow "check"
###
